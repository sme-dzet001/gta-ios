...
//        self.activityIndicator.hidesWhenStopped = true
    ...
    private func setHardCodeData() {
        ...
        let firstSection = [AppInfo(app_name: "Report Outages, System Issues", app_title: "Report Issue", appImageData: AppsImageData(app_icon: "", imageData: bellData?.pngData(), imageStatus: .loaded), appStatus: .none, app_is_active: true), AppInfo(app_name: "Reset Account Access & login Assistance", app_title: "Login Help", appImageData: AppsImageData(app_icon: "", imageData: loginHelpData?.pngData(), imageStatus: .loaded), appStatus: .none, app_is_active: true), AppInfo(app_name: "Description, wiki and support information", app_title: "About", appImageData: AppsImageData(app_icon: "", imageData: aboutData?.pngData(), imageStatus: .loaded), appStatus: .none, app_is_active: true), AppInfo(app_name: "Get the most from the app", app_title: "Tips & Tricks", appImageData: AppsImageData(app_icon: "", imageData: tipsNtricksData?.pngData(), imageStatus: .loaded), appStatus: .none, app_is_active: true), AppInfo(app_name: "Key Contacts and Member Profiles", app_title: "Contacts", appImageData: AppsImageData(app_icon: "", imageData: contactsData?.pngData(), imageStatus: .loaded), appStatus: .none, app_is_active: true)]
