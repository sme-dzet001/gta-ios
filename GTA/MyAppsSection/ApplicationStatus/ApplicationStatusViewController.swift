...
class ApplicationStatusViewController: UIViewController, ShowAlertDelegate {
    ...
    private func setHardCodeData() {
        ...
        let firstSection = [AppInfo(app_name: "Report Outages, System Issues", app_title: "Report Issue", app_icon: "", appStatus: .none, app_is_active: true, imageData: bellData?.pngData()), AppInfo(app_name: "Reset Account Access & login Assistance", app_title: "Login Help", app_icon: "", appStatus: .none, app_is_active: true, imageData: loginHelpData?.pngData()), AppInfo(app_name: "Description and list of app contacts", app_title: "About", app_icon: "", appStatus: .none, app_is_active: true, imageData: aboutData?.pngData())]
