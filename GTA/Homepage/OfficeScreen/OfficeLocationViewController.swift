...
class OfficeLocationViewController: UIViewController {
    ...
    private func setHardcodeData() {
        ...
        regionDataSource = [Hardcode(imageName: "", text: "Nashville", additionalText: "25 Madison Avenue, New York, NY"), Hardcode(imageName: "", text: "Culver City", additionalText: "10202 Washington Blvd, Culver City, CA"), Hardcode(imageName: "", text: "Lyndhurst", additionalText: "210 Clay Avenue, Lyndhurst, NJ"), Hardcode(imageName: "", text: "Madison Avenue", additionalText: "25 Madison Avenue, New York, NY"), Hardcode(imageName: "", text: "Culver City", additionalText: "10202 Washington Blvd, Culver City, CA"), Hardcode(imageName: "", text: "Lyndhurst", additionalText: "210 Clay Avenue, Lyndhurst, NJ"), Hardcode(imageName: "", text: "Madison Avenue", additionalText: "25 Madison Avenue, New York, NY"), Hardcode(imageName: "", text: "Madison Avenue", additionalText: "25 Madison Avenue, New York, NY")]
    }
